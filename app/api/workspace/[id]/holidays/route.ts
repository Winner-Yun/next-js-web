...
async function proxyHolidays(
  ...
  try {
    ...
    const targetUrl = `${BACKEND_URL.replace(/\/$/, "")}/workspace/${workspace_id}/holidays`;
    ...
    console.error(`Proxy ${method} holidays error:`, error);
...
export async function GET(
  ...
  return proxyHolidays(request, params, "GET");
}
...
export async function POST(
  ...
  return proxyHolidays(request, params, "POST");
}
